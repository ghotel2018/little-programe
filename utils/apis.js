...
export function getQuasiOrderInfo(options) {
  ...
  success(hackData["quasiOrderInfo"]);
...
export function getOrderInfo(options) {
  ...
  var data = hackData['commonOrderInfo']
  if (order_id === "d1a9b494-e331-4a77-bbaa-4875e518e67d") {
    data = hackData['waitPayOrderInfo']
  } else if (order_id === "6b98a502-7854-4d22-897f-610f3879f0b8") {
    data = hackData['canceledOrderInfo']
  }
  success(data)
